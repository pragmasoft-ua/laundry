...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.laundry.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.laundry.domain.Authority.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.laundry.domain.WashPrice.class.getName(), jcacheConfiguration);
